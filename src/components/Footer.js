  ...
  return (
    <div className='flex flex-col mt-20 p-16 pb-8 gap-4 font-thin w-full'>
        <div className='grid grid-cols-2 gap-6 md:flex-row md:flex justify-between items-start'>
            <div className='w-[200px] h-[200px] md:hidden lg:flex lg:items-center justify-center col-span-2 relative'>
                <Image src={""} 
                alt="Learntube graphic"
                layout='fill'
                objectFit='contain'
                />    
            </div>
            ...
            <div className="flex flex-col gap-2 cursor-pointer">
                ...
                <div className="text-sm">
                    <ul>
                        ...
                        <Link href="/micro-learn"><li className="hover:text-primaryYellow"></li>Micro-Learn</Link>
                    </ul>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-2 cursor-pointer">
                ...
                <div className="text-sm">
                    <ul>
                        ...
                        <Link href="/"><li className="hover:text-primaryYellow"></li>Most Completed</Link>
                    </ul>
                </div>
            </div>
