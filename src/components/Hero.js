      ...
      <div className="flex flex-col gap-y-12 md:flex-col lg:flex-row justify-between items-center">
        <div className="flex flex-col gap-y-4">
          ...
          <p className="max-w-[60%] text-xs md:text-base">
            Re-imagine the way you learn. We&apos;ve collected the most helpful content across
            YouTube and organized it into learning pathways.
          </p>
          <motion.button
            type="button"
            whileTap={{ scale: 0.8 }}
            className="w-[50%] md:w-[20%] lg:w-[35%] mt-4 text-xs md:text-base animate-pulse bg-gradient-to-r from-blue-500 via-pink-500 to-red-500 text-white px-4 py-2 rounded-md"
          >
            Start Learning
          </motion.button>
        </div>
